    ...
    def forward(self, tgt_sub, tgt_obj, tgt_rel, memory,
        ...
        for layer_id in range(self.num_layers):
            ...
            if layer_id != self.num_layers - 1:
                ...
                triplet_features = torch.cat([sub_features, obj_features, rel_features], -1)
                triplet_pos = torch.cat([subject_pos, conditional_object_pos, conditional_relation_pos], -1)
